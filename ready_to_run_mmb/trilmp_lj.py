...
trilmp=TriLmp(initialize=True,                          # use mesh to initialize mesh reference
              ...
              output_prefix='data/lj',                  # OUTPUT: prefix for output filenames
              restart_prefix='data/lj',                 # OUTPUT: name for checkpoint files
              ...
              # include LJ types of interactions
              n_types=1,
              bead_pos=coord_nanop,
              bead_vel=([[0,0,0]]),
              bead_sizes=(sigma_nanop),
              bead_int='lj/cut',
              bead_int_params=(10, 1.5),
              bead_types=(2),
              bead_masses=1,
              )
