...
trilmp=TriLmp(mesh_points=mesh.vertices,  # input mesh
              ...
              thin=1,                     # write out
              num_steps=5,             # number of steps in simulation (overwritten if trilmp.run(N=new_number)
              ...
              output_format='h5_custom',  # choose different formats for 'lammps_txt' or 'h5_custom'
